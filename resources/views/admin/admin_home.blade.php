      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route("check_admins")}}">Admin Users</a>
            <a class="collapse-item" href="{{route("check_therapists")}}">Therapist Users</a>
            <a class="collapse-item"href="{{route("check_normalusers")}}">Normal Users</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('view_all')}}">View All</a>
            <a class="collapse-item" href="{{route('create_posts')}}">Create Post</a>
