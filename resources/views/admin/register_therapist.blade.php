        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Register for new profile.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form"  method="POST" action="{{ route('store_therapist_info') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input id="password-confirm" placeholder="Re-confirm Password" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    {!!  Form::select('gender', ['Male' => 'Male','Female' => 'Female', 'Other' => 'Others' ],  'Male', ['class' => 'form-control ' ]) !!}
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control"name="age" id="age" placeholder="Age" type="number">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input id="religion" name="religion" class="form-control" placeholder="Religion" type="text">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Marital Status" type="text">
                  </div>
                </div>
                {{-- <div class="text-muted font-italic"><small>password strength: <span class="text-success font-weight-700">strong</span></small></div> --}}
                <div>
                  {{-- <input type="file" class="btn btn-success mt-1" style="color:white;"></input> --}}
